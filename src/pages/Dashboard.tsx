...
const Dashboard = () => {
  return (
    <div className="bg-primary-500/60 relative text-white  w-full min-h-screen flex  ">
      <div className=" hidden sticky shrink-0 h-screen top-0 md:flex py-10 shadow-2xl bg-white text-black rounded-r-[15px] flex-col justify-between px-4  left sm:w-[30%] md:w-[20%]">
      ...
      <div
        className={`mt-6 flex-1 px-5 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6`}
      >
        ...
        <div className="bg-white h-[250px] rounded-[20px]  border-white"></div>
        <div className="bg-white h-[250px] rounded-[20px]  border-white"></div>
        <div className="bg-white rounded-[20px] border-white md:col-span-2"></div>
